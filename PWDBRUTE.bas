...
1000 if len(pass$) = 7 then let guess$ = char7$+char6$+char5$+char4$+char3$+char2$+char1$
1010 if len(pass$) = 8 then let guess$ = char8$+char7$+char6$+char5$+char4$+char3$+char2$+char1$
...
1050 print "My Guess = ";guess$;" : Attempt = ";attempt
1060 if guess$ = pass$ then goto 1080
1070 return
1080 let finish$ = date$
1090 print
1100 print "Your chosen password is ";guess$
1110 print "Cracked in ";attempt;" attempts"
1120 print "Started : ";start$
1130 print "Finished: ";finish$
1140 print
1150 input "Run again (Y/N): ";response$
1160 if response$ = "Y" or response$ = "y" then goto 20
1170 end
1180 let check = 0
1190 if u$ = "N" then goto 1210
1200 if tmp >= ust and tmp <= ufi then let check = 1
1210 if l$ = "N" then goto 1230
1220 if tmp >= lst and tmp <= lfi then let check = 1
1230 if n$ = "N" then goto 1250
1240 if tmp >= nst and tmp <= nfi then let check = 1
1250 if p$ = "N" then goto 1270
1260 if tmp >= pst1 and tmp <= pfi1 then let check = 1
1270 if p$ = "N" then goto 1290
1280 if tmp >= pst2 and tmp <= pfi2 then let check = 1
1290 if p$ = "N" then goto 1310
1300 if tmp >= pst3 and tmp <= pfi3 then let check = 1
1310 if p$ = "N" then goto 1330
1320 if tmp >= pst4 and tmp <= pfi4 then let check = 1
1330 return
